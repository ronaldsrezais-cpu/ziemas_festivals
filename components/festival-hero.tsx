  ...
  return <section className="relative isolate overflow-hidden bg-[#0c0942] text-white" aria-labelledby="festival-title">
    ...
    <div className="relative mx-auto max-w-7xl px-5 py-14 sm:px-8 sm:py-18 lg:py-20">
      <div className="relative z-10 max-w-2xl">
        ...
        <p className="mt-7 max-w-md text-lg leading-7 text-white/85 sm:text-xl">Piesaki savu skolu. Pulcē komandu.<br />Satiekamies sportā!</p>
      ...
      <div className="absolute right-[11%] top-[22%] hidden rotate-[-8deg] md:block" aria-hidden="true">
